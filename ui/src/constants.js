...
// const BRIDGE_URL = process.env.REACT_APP_WALLET_URL || `${WALLET_PROTOCOL}://${WALLET_HOST}:${CONVERTER_PORT}/`

// export default { CREATOR_WALLET, CONVERTER_WALLET, DECOMPOSER_WALLET, BRIDGE_URL }
export default { CREATOR_WALLET, CONVERTER_WALLET, DECOMPOSER_WALLET }
